            ...
            <Col lg={12} sm={24} md={24} data-aos="fade-right">
              <Card bordered={false}>
                ...
                <p className="info-text">
                  ...
                  modern technologies. As a <strong>Computer Scientist</strong>{" "}
                  I am also keen to have outstanding knowledge React Redux,
                  Redux thunk, React Hooks, Java, C, Data Structures and
                  Algorithms too.
                </p>
              </Card>
            </Col>
